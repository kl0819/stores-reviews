...
// Helper Method: Load places(stores) near the given lat & lng 
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/v1/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    // map over places array to make marker for each location
